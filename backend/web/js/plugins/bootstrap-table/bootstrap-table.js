...
(function ($) {
    ...
    BootstrapTable.prototype.onSort = function (event) {
        ...
        location.hash = hashArr[0]+'-'+hashArr[1]+'-'+this.options.sortName+'-'+this.options.sortOrder;
    ...
    BootstrapTable.prototype.updatePagination = function (event) {
        ...
        location.hash = this.options.pageNumber+'-'+this.options.pageSize;
    ...
    BootstrapTable.prototype.initServer = function (silent, query, url) {
        ...
        if (this.options.queryParamsType === 'limit') {
            ...
            if (this.options.pagination) {
                params.page = this.options.pageSize === this.options.formatAllRows() ?
                    0 : this.options.pageNumber ;/*(this.options.pageSize * (this.options.pageNumber - 1));*/
        ...
        request = $.extend({}, calculateObjectValue(null, this.options.ajaxOptions), {
            ...
            url:  url || this.options.url+location.search,
