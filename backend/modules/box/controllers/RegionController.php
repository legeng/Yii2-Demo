...
use common\models\searchs\RegionSearch;
...
class RegionController extends BaseController
{
    ...
    //获取区域
    public function actionSearchRegion($q = null, $id = null) {
        Yii::$app->response->format = Response::FORMAT_JSON;
        ...
        if (!is_null($q)) {
            ...
            $query->select(['a.id id','concat(ifnull(c.name,"")," ",ifnull(b.name,"")," ",a.name) as text'])
                ->rightJoin('base_region b' ,'a.pid=b.id')
                ->rightJoin('base_region c' ,'b.pid=c.id')
                ->from('base_region a')
                ->where(['like', 'concat(ifnull(c.name,"")," ",ifnull(b.name,"")," ",a.name)', $q])
                ->limit(20);
